...
conn = cx_Oracle.connect(user='c#2020', password='2020BTECS00033', dsn=dsn_tns) 
c = conn.cursor()
...
usr_name = Label(window ,text = f"Connected to DB as: c#2020", background="orange").grid(row = 0, column = 1, pady=20)
